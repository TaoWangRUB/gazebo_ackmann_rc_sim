...
namespace imu_transformer
{
  ...
  : Node("imu_transformer", options), 
    imu_sub_(this, "imu_in", rclcpp::QoS(rclcpp::KeepLast(10)).best_effort().get_rmw_qos_profile()),
    mag_sub_(this, "mag_in", rclcpp::QoS(rclcpp::KeepLast(10)).reliable().get_rmw_qos_profile())
  {
